...
from src.scraper.multi_source_fetcher import get_latest_finance_news
...
def job():
    ...
    for item in news_items:
        ...
        try:
            ...
            facebook_caption = f"📈 Financial Edge Daily Update! 📈\n\n{title}\n\nStay tuned for more updates! 👇\n#FinanceNews #StockMarket #Economy #Investing #Wealth #FinancialEdgeDaily"
        ...
        repo_name = os.getenv("GITHUB_REPOSITORY", "Vikram-Bosak/Financial-Edge-Daily-image-agent")
        run_id = os.getenv("GITHUB_RUN_ID", "")
        server_url = os.getenv("GITHUB_SERVER_URL", "https://github.com")
        repo_url = f"{server_url}/{repo_name}"
        run_url = f"{repo_url}/actions/runs/{run_id}" if run_id else "N/A"

        report = f"""✅ Financial Edge Daily Pipeline Run Completed
